...
- **🔄 实时同步**：对话进行中，时间轴自动实时更新，新消息发送后立即显示对应节点，无需刷新页面。
...
### 鱼眼模式
当对话消息数量较多时，扩展会自动启用鱼眼模式：
- **焦点区域**：当前阅读位置周围的消息显示为独立节点
- **聚合节点**：远处的消息被聚合为一个节点，显示消息数量
- **平滑导航**：滚动时焦点区域自动跟随，提供流畅的浏览体验
